        ...
        <div className="modal-dialog modal-dialog-centered" role="document">
          <div className="modal-content obs-delete-modal-content text-dark">
            <div className="modal-header obs-delete-modal-header">
              <h5 className="modal-title" id="about-modal-title">
                About
              </h5>
              <button
                type="button"
            ...
            <div className="modal-body obs-delete-modal-body">
              <p className="obs-delete-modal-lead mb-2">
                <strong>Notes</strong> is a Markdown vault workspace for your
                notes and folders.
              </p>
              <p className="text-muted small mb-0">Version {APP_VERSION}</p>
            </div>
